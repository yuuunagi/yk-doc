"use strict";(self.webpackChunkyk_doc=self.webpackChunkyk_doc||[]).push([[972],{25972:function(sn,h,a){a.r(h),a.d(h,{default:function(){return nn}});var Z=a(38138),s=a(92896),i=a(75271),O=a(7802),x=a(66283),T=a(70922),g=a(48881),D=function(n,e){return i.createElement(g.Z,(0,x.Z)({},n,{ref:e,icon:T.Z}))},X=i.forwardRef(D),y=X,B={icon:{tag:"svg",attrs:{viewBox:"64 64 896 896",focusable:"false"},children:[{tag:"path",attrs:{d:"M890.5 755.3L537.9 269.2c-12.8-17.6-39-17.6-51.7 0L133.5 755.3A8 8 0 00140 768h75c5.1 0 9.9-2.5 12.9-6.6L512 369.8l284.1 391.6c3 4.1 7.8 6.6 12.9 6.6h75c6.5 0 10.3-7.4 6.5-12.7z"}}]},name:"up",theme:"outlined"},K=B,F=function(n,e){return i.createElement(g.Z,(0,x.Z)({},n,{ref:e,icon:K}))},G=i.forwardRef(F),b=G,H=a(19984),J=function(n,e){return i.createElement(g.Z,(0,x.Z)({},n,{ref:e,icon:H.Z}))},Q=i.forwardRef(J),M=Q,V=a(68662),W=a(43953),Y=a(82187),u=a.n(Y),$=a(32595),w=a(72998),r=a(27988),S,R,z,L,j,A,k=(0,W.kc)(function(l){var n=l.token,e=l.css,o=n.colorSplit,t=n.iconCls,c=n.fontSizeIcon;return{prevNextNavMobile:e(S||(S=(0,s.Z)([`
      position: fixed;
      top: 40%;
      right: 10px;
      z-index: 2;
